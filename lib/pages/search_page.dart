...
import 'package:tindog/services/marker_service.dart';
...
class Search extends StatelessWidget {
    ...
    return FutureProvider(
      ...
      child: Scaffold(
        body: (currentPosition != null)
            ? Consumer<List<Place>>(
                builder: (_, places, __) {
                  var markers = (places != null) ? markerService.getMarkers(places):
                  List<Marker>();
                      ...
                      Expanded(
                        child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return FutureProvider(
                                create: (context) => geolocatorService.getDistance(
                                ...
                                child: Card(
                                  child: ListTile(
                                    ...
                                    trailing: IconButton(
                                      ...
                                      color: Colors.blue,
                                      onPressed: () {
                                        _launchMapUrl(places[index].geometry.location.lat,
                                         places[index].geometry.location.lng);
                                      },
                                    ),
                                  ),
  ...
  void _launchMapUrl(double lat, double lng) async{
    ...
    if( await canLaunch(url) ){
      ...
      throw 'No se pudo mostrar la información';
    }
  }
}
